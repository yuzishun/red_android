...
import com.heshi.niuniu.im.sample.ChattingOperationCustomSample;
...
public class PreviewImImageActivity extends Activity {

    private static final String TAG = "PreviewImImageActivity";
        ...
        if (mMessage.getMsgReadStatus() == YWMessage.MSG_READED_STATUS || file.exists()){
            ...
            fileManager.downloadFile(mImageUrl, Constant.STORE_PATH, name, new IWxCallback() {
                ...
                public void onError(int code, String info) {
                    ...
                    Notification.showToastMsg(PreviewImImageActivity.this, "图片下载失败，请稍后再试！");
                }
