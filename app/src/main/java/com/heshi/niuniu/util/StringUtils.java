...
public class StringUtils {
    ...
    public static String fileName(String str){
        ...
        String rightStr = "";
        if (pointIndex!=-1){
            leftStr = str.substring(0,pointIndex);
            rightStr = str.substring(pointIndex,str.length());
        }else{
            leftStr=str;
            rightStr="";
        }
        ...
        String endStr;
        if (leftStr.length()>4){
            startStr =leftStr.substring(0,2);
            endStr= leftStr.substring(leftStr.length()-2,leftStr.length());
            leftStr = startStr +"..."+ endStr;
        }
